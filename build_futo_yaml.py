...
def emit(layout_key: str, layers: dict[str, Any], placement: str, strict: bool,
    ...
    L.append("#")
    L.append("# Generated by build_futo_yaml.py from https://polish-typographic.com.")
    L.append("# This copy is upstream's: patch it directly if you need to, and tell")
    L.append("# github.com/AndrewKirkovski so the change goes back into the generator.")
    L.append("# Nothing regenerated here will land on top of an upstream edit.")
    L.append("# Built from " + cfg["full"] + ".")
    L.append("#")
